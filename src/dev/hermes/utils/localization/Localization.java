package dev.hermes.utils.localization;
...
public class Localization {
    ...
    /**
     * Gets a translated string using the Razer's current locale
     * @param key The key of the string to translate
     * @return The translated string of the key, using the Razer's current locale
     */
    public static String get(String key) {
        return get(key, Hermes.locale);
    }
    ...
    public static void populate() {
        for (Locale locale : Locale.values()) {
            ResourceLocation resourceLocation = new ResourceLocation("hermes/text/" + locale.getFile() + ".properties");
