...
public class SleepVelocity extends Mode<Velocity> {
    ...
    @EventTarget
    public void PreUpdateEvent(EventUpdate eventUpdate){
    ...
    private void addPackets(TimestampedPacket packet, EventReceivePacket eventReadPacket) {
    ...
    private void kbAlert(EventReceivePacket e) {
                ...
                try {
                    ...
                    if (mc.thePlayer.hurtTime == 0) { // 如果还是没有收到任何伤害
                        if (e.getPacket() instanceof S12PacketEntityVelocity) { // handle S12
                            ...
                            ChatManager.display("You may have been KB checked! S12 #" + mc.thePlayer.ticksExisted);
                            ...
                            ChatManager.display("You may have been KB checked! S27 #" + mc.thePlayer.ticksExisted);
