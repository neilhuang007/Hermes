...
public class NumberValue extends Value<Float> {
    ...
    public NumberValue(String name, Float value, Float minimum, Float maximum, Float step, String suffix,
    ...
    public NumberValue(String name, Float value, Float minimum, Float maximum, Float step) {
        this(name,value,minimum,maximum,step,"",() -> true);
    }

    public NumberValue(String name, Float value, Float minimum, Float maximum) {
        this(name,value,minimum,maximum, 0.1F,"",() -> true);
    }

    public NumberValue(String name, Float value, Float minimum, Float maximum, Function0<Boolean> displayable) {
        this(name,value,minimum,maximum, 0.1F,"",displayable);
    }

    public NumberValue(String name, Float value, Float minimum, Float maximum, Float step, Function0<Boolean> displayable) {
