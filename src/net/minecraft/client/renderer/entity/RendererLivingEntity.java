...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures)
    {
        ...
        else
        {
            ...
            if (flag1)
            {
                if(Hermes.moduleManager.get("CombatSettings").isEnabled() && ((Boolean) Hermes.moduleManager.get("CombatSettings").getAllValues().get(1).getValue())){
                    Color hitColor = (Color) Hermes.moduleManager.get("CombatSettings").getAllValues().get(2).getValue();
                    this.brightnessBuffer.put(hitColor.getRed() / 255.0F);
                    this.brightnessBuffer.put(hitColor.getGreen() / 255.0F);
                    this.brightnessBuffer.put(hitColor.getBlue() / 255.0F);
                    this.brightnessBuffer.put(hitColor.getAlpha() / 255.0F);
                }else{
